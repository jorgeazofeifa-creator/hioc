...
check "Incident engine executable" test -x "$INSTALL_DIR/pi4/bin/hioc-incident-engine.sh"
...
check "Cron installed" bash -c "crontab -l 2>/dev/null | grep -Fq '$INSTALL_DIR/pi4/bin/hioc-incident-engine.sh'"
